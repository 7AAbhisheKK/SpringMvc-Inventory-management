...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css" integrity="sha512-+4zCK9k+qNFUR5X+cKL9EIR+ZOhtIloNl9GIKS57V1MyNsYpYcUrUeQc9vNfzsWfV28IaLL3i96P9sdNyeRssA==" crossorigin="anonymous" media='all'/>
<script src= 
...
function myFunction(status) {
	status=!status
	  ...
	  document.getElementById("v").value = status;
	  console.log("hello");
	  console.log(document.getElementById("v").value);
	}
